...
<title>RinseRight | Ticket Update</title>
</head>
<body>
	<script>
		function goBack() {
	...
	<div id="headerDiv">
		<p id="header">UPDATE YOUR TICKET</p>
		<div id="headIcon">
	...
	<div id="formDiv">
		<form action="<%=request.getContextPath()%>/updateTicket"
			method="post">
			...
			<div id="enterInquiryDiv">
				...
				<textarea name="inquiry" class="box" cols="160" rows="30" required  placeholder = "${ticket.inquiry}"> ${ticket.inquiry} </textarea>
			</div>

			<div id="enterSuggestionsDiv">
				<p class="boxLabel">ANY SUGGESTIONS?</p>
				<textarea name="suggestions" class="box" cols="160" rows="30"  placeholder = "${ticket.suggestions}"> ${ticket.suggestions} </textarea>
			</div>

			<div id="submitDiv">
				<input type="submit" value="UPDATE THE TICKET" id="submit" />
			</div>
		</form>
	</div>
</body>
